let commands = ['intro', 'about', 'tpdc', 'projects']

console.log("Welcome to the termin3zz alpha")
let command = prompt("Test input: ");

while (command !== 'exit') {
    // if (inputs.includes(command)) {
    //     if (command === 'intro') {
    ...
    // }
    switch (command) {
      // This keeps on looping over the other options may need to put this in it's own conditional
      // case 'help':
